...
\begin{enumerate}[label=\roman*.]
    \item \textbf{Operating System:} Linux distribution like Ubuntu 26.04 LTS with stable CUDA support.
    \item \textbf{Programming Languages:} Python 3.10+ for model development, Rust for high performance edge execution and Kotlin for mobile application development.
    \item \textbf{IDE/Tools:} VS Code, Jupyter Notebooks for experimentation, and Git for version control.
    \item \textbf{Core Framework:} PyTorch 2.0+ or TensorFlow 2.x (primarily PyTorch for YOLO implementation).
